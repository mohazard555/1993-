...
const DEFAULT_CONFIG: AppConfig = {
  ...
  siteLogoUrl: "data:image/png;base64,..."},
};
...
const Header: React.FC<{ 
  ...
  onAdsClick: () => void;
  siteLogoUrl: string;
}> = ({ onSettingsClick, onLogoClick, isAuthenticated, hasAds, onAdsClick, siteLogoUrl }) => (
    <header className="text-center py-8 md:py-12 relative">
    <ThemeToggle />
    <div onClick={onLogoClick} className="inline-block cursor-pointer select-none">
        <img src={siteLogoUrl} alt="ذكاء النصوص AI Logo" className="h-16 md:h-20 w-auto mx-auto" />
    </div>
